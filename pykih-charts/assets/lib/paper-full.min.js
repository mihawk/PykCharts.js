...
} else {obj[name] = desc.value;}return obj;},
define = function(obj, name, desc) {delete obj[name];return _define(obj, name, desc);};
...
for (var name in beansNames) {var part = beansNames[name],set = dest['set' + part],
...
statics: {each: each,create: create,define: define,describe: describe,set: set,
clone: function(obj) {
