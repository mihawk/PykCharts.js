...
var Base=new function(){function u(t,n,r,s,u){function f(e,f){f=f||(f=i(n,e))&&(f.get?f:f.value);if(typeof f==="string"&&f[0]==="#")f=t[f.substring(1)]||f;var l=typeof f==="function",c=f,h=u||l?f&&f.get?e in t:t[e]:null,p;if(!u||!h){if(l&&h)f.base=h;if(l&&s!==false&&(p=e.match(/^([gs]et|is)(([A-Z])(.*))$/)))a[p[3].toLowerCase()+p[4]]=p[2];if(!c||l||!c.get||typeof c.get!=="function"||!Base.isPlainObject(c))c={value:c,writable:true};if((i(t,e)||{configurable:true}).configurable){c.configurable=true;c.enumerable=r}o(t,e,c)}}var a={};if(n){for(var l in n){if(n.hasOwnProperty(l)&&!e.test(l))f(l)}for(var l in a){var c=a[l],h=t["set"+c],p=t["get"+c]||h&&t["is"+c];if(p&&(s===true||p.length===0))f(l,{get:p,set:h})}}return t}function a(e,r,i){if(e)("length"in e&&!e.getLength&&typeof e.length==="number"?t:n).call(e,r,i=i||e);return i}function f(e,t){for(var n in t)if(t.hasOwnProperty(n))e[n]=t[n];return e}var e=/^(statics|enumerable|beans|preserve)$/,t=[].forEach||function(e,t){for(var n=0,r=this.length;n<r;n++)e.call(t,this[n],n,this)},n=function(e,t){for(var n in this)if(this.hasOwnProperty(n))e.call(t,this[n],n,this)},r=Object.create||function(e){return{__proto__:e}},i=Object.getOwnPropertyDescriptor||function(e,t){var n=e.__lookupGetter__&&e.__lookupGetter__(t);return n?{get:n,set:e.__lookupSetter__(t),enumerable:true,configurable:true}:e.hasOwnProperty(t)?{value:e[t],enumerable:true,configurable:true,writable:true}:null},s=Object.defineProperty||function(e,t,n){if((n.get||n.set)&&e.__defineGetter__){if(n.get)e.__defineGetter__(t,n.get);if(n.set)e.__defineSetter__(t,n.set)}else{e[t]=n.value}return e},o=function(e,t,n){delete e[t];return s(e,t,n)};return u(function(){for(var t=0,n=arguments.length;t<n;t++)f(this,arguments[t])},{inject:function(e){if(e){var t=e.statics===true?e:e.statics,n=e.beans,r=e.preserve;if(t!==e)u(this.prototype,e,e.enumerable,n,r);u(this,t,true,n,r)}for(var i=1,s=arguments.length;i<s;i++)this.inject(arguments[i]);return this},extend:function(){var e=this,t;for(var n=0,i=arguments.length;n<i;n++)if(t=arguments[n].initialize)break;t=t||function(){e.apply(this,arguments)};t.prototype=r(this.prototype);t.base=e;o(t.prototype,"constructor",{value:t,writable:true,configurable:true});u(t,this,true);return arguments.length?this.inject.apply(t,arguments):t}},true).inject({inject:function(){for(var e=0,t=arguments.length;e<t;e++){var n=arguments[e];if(n)u(this,n,n.enumerable,n.beans,n.preserve)}return this},extend:function(){var e=r(this);return e.inject.apply(e,arguments)},each:function(e,t){return a(this,e,t)},set:function(e){return f(this,e)},clone:function(){return new this.constructor(this)},statics:{each:a,create:r,define:o,describe:i,set:f,clone:function(e){return f(new e.constructor,e)},isPlainObject:function(e){var t=e!=null&&e.constructor;return t&&(t===Object||t===Base||t.name==="Object")},pick:function(){for(var e=0,t=arguments.length;e<t;e++)if(arguments[e]!==undefined)return arguments[e]}}})}
