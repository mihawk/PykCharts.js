	...
	var configuration = {
        ...
        export : function(chart,svgId,chart_name) {
            ...
            if(PykCharts.boolean(options.export_enable)) {
                ...
                var light =  false;
                console.log($(options.selector));
                for(var i=0; i < $(options.selector)[0].classList.length;i++) {
                    console.log($(options.selector)[0].classList[i],"mar java");
                    if($(options.selector)[0].classList[i] === "light") {
                        light = true;
                    }
                }
                console.log(light,"light");
                    console.log("haiii",$(options.selector));   
                if ($(options.selector).hasClass("light")) {
                    console.log("haiii",$(options.selector));
	...
	this.optionalFeature = function (){
		var optional = {
			...
			svgContainer: function (i){
				...
				// $(options.selector).hasClass("light");
...
PykCharts.multiD.spiderWeb = function (options) {
    ...
    this.execute = function () {
        ...
        that.variable_circle_size_enable = options.variable_circle_size_enable ? options.variable_circle_size_enable : theme.multiDimensionalCharts.variable_circle_size_enable;
