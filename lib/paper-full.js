...
var Formatter = Base.extend({
	...
	size: function(val, separator) {
		//console.log(this.number(val.width))
...
var Matrix = Base.extend({
	...
	getTranslation: function() {
		console.log("tx","ty",this._tx, this._ty,new Point(this._tx, this._ty));
...
var Raster = Item.extend({
	...
	getSubCanvas: function() {
		...
		console.log(rect.x,rect.y,"rect canvas");
...
var SVGStyles = Base.each({
	...
	// stroke-opacity: ['stroke-opacity','number']
}, function(entry, key) {
	var part = Base.capitalize(key),
		lookup = entry[2];
	this[key] = {
...
//			console.log(point,"point",center);
	...
	function exportRaster(item) {
		...
		console.log(createElement('image', attrs),"exportRaster")
	...
	function exportPlacedSymbol(item, options) {
		...
		attrs.x += bounds.x;
		attrs.y += bounds.y;
					console.log(attrs.x,attrs.y,"attr.x","attrs");
...
new function() {
	...
	var importers = {
		...
		image: function (node) {
			...
			raster.attach('load', function() {
				...
				console.log(this._matrix,"this")
				var center = this._matrix._transformPoint(
						getPoint(node, 'x', 'y').add(size.divide(2)));
				console.log(size,"size",center);
				this.translate(center);
			//	console.log(raster,"raster",Raster)
			});
			return raster;
		},
	...
	//	console.log(name,"name");
		...
		//console.log(color,"color",name,"name",item,"item",value);
		if (color) {
		//	console.log(color,"color",color.setAlpha(parseFloat(value)));
	...
	var attributes = Base.each(SVGStyles, function(entry) {
		...
		//	console.log(entry,"entry",entry.type,item[entry.set],entry.set);
