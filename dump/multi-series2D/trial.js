PykCharts.multi_series_2D.ultimate = function(options){
    ...
    this.render = function(){
        ...
        console.log(that.the_bars,"the_bars");
        console.log(that.the_keys,"the_keys"); 
        ...
        if(that.mode === "default") {
            ...
            console.log(that.x0.domain(),that.xScale.domain());
        ...
        var optional = {
            ...
            createColumnChart: function() {
                ...
                layers.map(function(e, i){ // Get all values to create scale
                    for(i in e.values){
                        console.log(e,e.values,"e","e.values");
                ...
                that.columnMargin = (that.x0.rangeBand()/4);
                console.log(that.columnMargin,"columnMargin");
